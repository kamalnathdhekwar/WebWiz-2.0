...
const CenterComponent = () => {
  return (
    <div className='text-white items-center flex flex-col gap-12 w-full' style={{ backgroundImage: `url(${backImage})` }}>
      <div className='flex items-center justify-around mb-12 w-full'>
