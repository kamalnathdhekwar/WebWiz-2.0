...
const CenterComponent = () => {
  return (
    <div className='text-white items-center flex flex-col gap-[8rem] w-full '>
      <div className='md:flex-row flex flex-col  items-center justify-around mb-12 w-full'>
      ...
      <div className='flex md:flex-row  flex-col items-center mb-12 justify-around w-full'>
